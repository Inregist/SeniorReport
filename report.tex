...
\section{ผลการดำเนินงานในภาคการศึกษาที่ 2} 
  \begin{table}[H]
    ...
    \hline
    \textbf{No} & \multicolumn{1}{c|}{\textbf{ปัญหาที่พบ}}                                                                                                                                                                      & \multicolumn{1}{c|}{\textbf{วิธีการแก้ไข}}                                                                                                                                                                              \\ \hline
    1           & \begin{tabular}[c]{@{}l@{}}การเพิ่ม Shader ตัวละครหรือรูปภาพในเกม เช่น \\ การใส่สีเส้นขอบ ไม่รองรับรูปภาพที่แยกส่วนไว้ก่อนล่วงหน้า \\ ซึ่งจะถูกแยกไว้สำหรับ Animation ภายในเกม\\ 
                  \begin{minipage}
                    \includegraphics[width=0.2\textwidth, width=1cm]{./imgs/problem_before.png}
                  \end{minipage}
                  % //TODO: insert img in table
                  % \begin{figure}[H]\centering
                  %   \includegraphics[width=3cm]{./imgs/problem_before.png}
                  %   \caption{ภาพที่แยกส่วนแล้วเพิ่ม Shader}\label{fig:problem1}
                  %   \end{figure}
                  \end{tabular}         
                  & \begin{tabular}[c]{@{}l@{}}เปลี่ยนจากการทำ Animation แบบจัดกระดูก\\ เป็น Animation frame by frame (Sprite Sheet) \\ โดยใช้โปรแกรม DragonBones\\
                      % \begin{figure}[H]\centering
                      %   \includegraphics[width=3cm]{./imgs/problem_after.png}
