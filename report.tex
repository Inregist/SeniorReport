...
that everyone should learn. But it is too risky to learn these skills 
in real-life situations. We would like to create a Real-time multiplayer 
...
and MDA theory using Unity as a game engine. After the game development process 
we did some surveys and got feedback telling us the game’s graphics are 
...
ผู้จัดทำอยากพัฒนาเกมที่สามารถให้ผู้เล่นได้ฝึกทัศนคติการวางแผน
ทักษะการตัดสินใจ และการแก้ไขปัญหาเฉพาะหน้า โดยเป็นการต่อสู้กันระหว่างผู้
เล่นสองคนแบบ real-time multiplayer สาเหตุที่ผู้จัดทำพัฒนาเกมในรูปแบบ
real-time multiplayer เนื่องจากการที่ผู้เล่นได้สู้กับผู้เล่นจริงนั้นทำให้สิ่งที่เกิดขึ้น
ภายในเกมมีความสดใหม่ ไม่ซ้ำเดิม เพิ่ม Replayability (คุณค่าของการเล่นเกมเดิมซ้ำ) 
เพราะผู้เล่นแต่ละคนมีความคิดหรือการวางแผนที่แตกต่างกัน
...
\begin{table}[H]
  ...
  \includegraphics[width=1.0\textwidth]{./imgs/tbl-2.png}
\end{table}
...
\begin{table}[H]
  ...
  \includegraphics[width=1.0\textwidth]{./imgs/gameDiff.png}
\end{table}
...
\begin{enumerate}
  ...
  \item \textbf{Player Sugar}
    ...
    \begin{figure}[H]\centering
      \includegraphics[width=4cm]{./imgs/player_sugar.jpg}
  ...
  \item \textbf{Player Animation}
    ...
    \begin{figure}[H]\centering
      \includegraphics[width=10cm]{./imgs/player_animation.jpg}
  ...
  \item \textbf{Interactable Object}
    ...
    \begin{figure}[H]\centering
      \includegraphics[width=10cm]{./imgs/Interactable.jpg}
  ...
  \item \textbf{User Interface Design}
    ...
    \begin{itemize}
      ...
      \begin{figure}[H]\centering
        \includegraphics[width=10cm]{./imgs/Home.png}
        \caption{หน้า Home}\label{fig:Home}
      \end{figure}

      \begin{figure}[H]\centering
        \includegraphics[width=10cm]{./imgs/Home1.png}
        \caption{หน้า Home เมื่อกดปุ่ม Tutorial}\label{fig:Home1}
      \end{figure}

      \begin{figure}[H]\centering
        \includegraphics[width=10cm]{./imgs/Home2.png}
      ...
      \begin{figure}[H]\centering
        \includegraphics[width=10cm]{./imgs/Quiz.png}
      ...
      \begin{figure}[H]\centering
        \includegraphics[width=10cm]{./imgs/Inventory.png}
...
\begin{table}[H]
  ...
  \begin{tabular}{|lllc|}
  \hline
  \multicolumn{1}{|c|}{\textbf{หัวข้อการดำเนินงาน}} & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}ยังไม่ได้\\ ดำเนินการ\end{tabular}}} & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}กำลัง\\ ดำเนินการ\end{tabular}}} & \textbf{เสร็จสิ้น}    \\ \hline
  \multicolumn{1}{|l|}{\textbf{Tutorial 1}}         & \multicolumn{1}{l|}{}                                                                       & \multicolumn{1}{l|}{}                                                                   & /                     \\ \hline
  \multicolumn{1}{|l|}{\textbf{Tutorial 2}}         & \multicolumn{1}{l|}{}                                                                       & \multicolumn{1}{l|}{}                                                                   & /                     \\ \hline
  \multicolumn{1}{|l|}{\textbf{User Interface}}     & \multicolumn{1}{l|}{}                                                                       & \multicolumn{1}{l|}{}                                                                   & /                     \\ \hline
  \multicolumn{4}{|l|}{\textbf{Core Gameplay}}                                                                                                                                                                                                                      \\ \hline
  \multicolumn{1}{|l|}{Host and Join}               & \multicolumn{1}{l|}{}                                                                       & \multicolumn{1}{l|}{}                                                                   & /                     \\ \hline
  \multicolumn{1}{|l|}{Player Movement}             & \multicolumn{1}{l|}{}                                                                       & \multicolumn{1}{l|}{}                                                                   & /                     \\ \hline
...
ระหว่างที่คณะผู้จัดทำได้ดำเนินการพัฒนาเกม คณะผู้จัดทำได้พบปัญหาและแก้ไขปัญหาต่าง ๆ โดยสรุปได้ดังนี้
  ...
  \subsubsection{ปัญหาที่พบ}
    \begin{table}[H]
      \caption{ปัญหาที่พบในภาคการศึกษาที่ 1}\label{tbl:tab-5}
      \begin{tabular}{|c|l|l|}
      \hline
      ...
      \end{tabular}
    \end{table}
  \subsubsection{คำแนะนำจากอาจารย์}
      \begin{table}[H]
        \caption{คำแนะนำจากอาจารย์}\label{tbl:tab-6}
        \begin{tabular}{|c|l|l|}
        \hline
        \textbf{No} & \multicolumn{1}{c|}{\textbf{ปัญหาที่พบ}}                                                                         & \multicolumn{1}{c|}{\textbf{วิธีการแก้ไข}}                                                                                                                                                 \\ \hline
  ...
  \subsection{ผลการดำเนินงานในภาคการศึกษาที่ 2} 
    \begin{table}[H]
      \caption{ปัญหาที่พบในภาคการศึกษาที่ 2}\label{tbl:tab-7}
      \begin{tabular}{|c|l|l|}
      \hline
      \textbf{No} & \multicolumn{1}{c|}{\textbf{ปัญหาที่พบ}}                                                                                                                                                                      & \multicolumn{1}{c|}{\textbf{วิธีการแก้ไข}}                                                                                                                                                                              \\ \hline
      1           & \begin{tabular}[c]{@{}l@{}}การเพิ่ม Shader ตัวละครหรือรูปภาพในเกม เช่น \\ การใส่สีเส้นขอบ ไม่รองรับรูปภาพที่แยกส่วนไว้ก่อนล่วงหน้า \\ ซึ่งจะถูกแยกไว้สำหรับ Animation ภายในเกมดังรูปที่~\ref{fig:problem1} \end{tabular}         & \begin{tabular}[c]{@{}l@{}}เปลี่ยนจากการทำ Animation แบบจัดกระดูก\\ เป็น Animation frame by frame (Sprite Sheet) \\ โดยใช้โปรแกรม DragonBones ดังรูปที่~\ref{fig:solution1} \end{tabular}                                                    \\ \hline
      ...
      5           & \begin{tabular}[c]{@{}l@{}}Unity ปรับเปลี่ยน Version Control จาก Unity Collaboration \\ เป็น Plastic SCM ทำให้งานบางส่วนไม่ถูกบันทึกไว้และหายไป\end{tabular}                                                  & เปลี่ยนไปใช้ Plastic SCM และทำงานในส่วนที่หายไปขึ้นใหม่                                                                                                                                                                 \\ \hline
      6           & \begin{tabular}[c]{@{}l@{}}การศึกษาการใช้งาน Unity มีความซับซ้อน \\ เช่น การทำ UI จะต้องคำนึงถึงอัตราส่วนขนาดหน้าจอที่ต่างกัน\end{tabular}                                                                    & \begin{tabular}[c]{@{}l@{}}ปรับ Canvas Scaling และจัด Anchor ของ UI Element ทุกชิ้น \\ หรือการจัดแผนที่ภายในเกมโดยใช้ Tilemap ผสมกับภาพ 2D \\ และจัดลำดับของ Layer ซึ่งจะต้องดูและปรับไปทีละส่วน\end{tabular}           \\ \hline
      \end{tabular}
    \end{table}
    ...
    \begin{figure}[H]\centering
      \begin{minipage}{.4\textwidth}
        \centering
        \includegraphics[width=1.5cm]{./imgs/problem_before.png}
        \caption{ภาพที่แยกส่วนแล้วเพิ่ม Shader}\label{fig:problem1}
      \end{minipage}
      \begin{minipage}{.4\textwidth}
        \centering
        \includegraphics[width=1.5cm]{./imgs/problem_after.png}
...
% \noindent{\large\bf Unit} ทั้ง Minionและ Tower นั้นแบ่งออกเป็น 
% 3 ประเภทหลัก ๆ ดังนี้

% \begin{enumerate}
%   \item \textbf{Attack :} Unit นี้จะมีหน้าที่โจมตีเป็นหลัก ได้แก่
%   \begin{table}[H]
%     \begin{tabular}{|l|ll|}
%     \hline
%     \rowcolor[HTML]{C0C0C0} 
...
%     Pudding                                                     & \multicolumn{1}{l|}{\%Stun Tower}                          & Slow Minion                                                  \\ \hline
...
%   \item \textbf{Defend :} Unit นี้จะมีหน้าที่ป้องกันเป็นหลัก ได้แก่
  

%   \item \textbf{Enchanter :} Unit นี้จะมี Skill ที่สามารถช่วยเหลือ 
%   Unit อื่นๆ ได้ ได้แก่
