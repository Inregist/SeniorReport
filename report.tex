...
ระหว่างที่คณะผู้จัดทำได้ดำเนินการพัฒนาเกม คณะผู้จัดทำได้พบปัญหาและแก้ไขปัญหาต่าง ๆ โดยสรุปได้ดังนี้
  ...
  \subsection{ผลการดำเนินงานในภาคการศึกษาที่ 2} 
    \begin{table}[H]
      ...
      7           & \begin{tabular}[c]{@{}l@{}}การศึกษาการใช้งาน Unity มีความซับซ้อน \\ เช่น การทำ UI จะต้องคำนึงถึงอัตราส่วนขนาดหน้าจอที่ต่างกัน\end{tabular}                                                                    & \begin{tabular}[c]{@{}l@{}}ปรับ Canvas Scaling และจัด Anchor ของ UI Element ทุกชิ้น \\ หรือการจัดแผนที่ภายในเกมโดยใช้ Tilemap ผสมกับภาพ 2D \\ และจัดลำดับของ Layer ซึ่งจะต้องดูและปรับไปทีละส่วน\end{tabular}           \\ \hline
      \end{tabular}
    \end{table}
