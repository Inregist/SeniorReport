...
\section{ผลการดำเนินงานในภาคการศึกษาที่ 2} 
  \begin{table}[H]
    ...
    \hline
    \textbf{No} & \multicolumn{1}{c|}{\textbf{ปัญหาที่พบ}}                                                                                                                                                                      & \multicolumn{1}{c|}{\textbf{วิธีการแก้ไข}}                                                                                                                                                                              \\ \hline
    1           & \begin{tabular}[c]{@{}l@{}}การเพิ่ม Shader ตัวละครหรือรูปภาพในเกม เช่น \\ การใส่สีเส้นขอบ ไม่รองรับรูปภาพที่แยกส่วนไว้ก่อนล่วงหน้า \\ ซึ่งจะถูกแยกไว้สำหรับ Animation ภายในเกมดังรูปที่~\ref{fig:problem1} \\ 
                  \end{tabular}         
                  & \begin{tabular}[c]{@{}l@{}}เปลี่ยนจากการทำ Animation แบบจัดกระดูก\\ เป็น Animation frame by frame (Sprite Sheet) \\ โดยใช้โปรแกรม DragonBones ดังรูปที่~\ref{fig:solution1} \\
                  \end{tabular}                                                    \\ \hline
